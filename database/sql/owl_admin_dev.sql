...
CREATE TABLE `admin_code_generators`  (
  ...
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '代码生成器' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `personal_access_tokens` VALUES (3, 'Slowlyo\\OwlAdmin\\Models\\AdminUser', 1, 'admin', 'bd5d818dae9b946f8a0655133ae4852d9110671ce462764e723e7853be94a333', '[\"*\"]', '2025-05-23 15:03:11', NULL, '2025-05-20 15:37:14', '2025-05-23 15:03:11');
